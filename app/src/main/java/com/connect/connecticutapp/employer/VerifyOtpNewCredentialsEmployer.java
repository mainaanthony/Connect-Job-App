...
public class VerifyOtpNewCredentialsEmployer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_otp_new_credentials_employer);
...
//        firebaseAuth = FirebaseAuth.getInstance();
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(VerifyOtpNewCredentialsEmployer.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    };
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                Toast.makeText(VerifyOtpNewCredentialsEmployer.this, "Verification not Completed", Toast.LENGTH_SHORT).show();
