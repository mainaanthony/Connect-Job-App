...
public class BondNewsAdapter extends RecyclerView.Adapter<BondNewsAdapter.ViewHolder> {

    private final ArrayList<BondNewsItem> parseItems;
    Context context;

    public BondNewsAdapter(ArrayList<BondNewsItem> parseItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BondNewsItem parseItem = parseItems.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(parseItem.getDetailUrl()));
