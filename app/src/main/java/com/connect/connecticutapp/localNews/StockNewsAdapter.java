...
public class StockNewsAdapter extends RecyclerView.Adapter<StockNewsAdapter.ViewHolder> {
    ...
    private final ArrayList<StockNewsItem> parseItems;
    Context context;

    public StockNewsAdapter(ArrayList<StockNewsItem> parseItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        StockNewsItem parseItem = parseItems.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(context, NewsStockDetailsActivity.class);
