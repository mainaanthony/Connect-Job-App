...
public class create_account_job_seeker_3 extends AppCompatActivity {
    //variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_account_job_seeker3);

        scrollview = findViewById(R.id.signup_3rd_screen_scroll_view);
        button1 = findViewById(R.id.signup_next_button_job_seeker_To_Otp);
        ...
        button2.setOnClickListener(view -> {
           Intent intent = new Intent(getApplicationContext(), com.connect.connecticutapp.dashboard_activity.class);
...
//Complete phone number
       ...
       intent.putExtra("WhatToDo", "createNewUser");// This is to identify that which action should OTP perform after verification.
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(create_account_job_seeker_3.this, pairs);
